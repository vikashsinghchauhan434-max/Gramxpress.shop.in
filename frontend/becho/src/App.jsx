...
const CATEGORIES = {
  ...
  Juice:      { icon: '🧃', subcategories: ['Fresh Juices','Packed Juices','Smoothies','Shakes','Coconut Water','Energy Drinks','Lemon & Nimbu Pani'] },
  Kitchen:    { icon: '🍽️', subcategories: ['Dinner Sets','Thali & Plates','Glasses & Cups','Bowls & Katoris','Cookware','Storage Containers','Spoons & Cutlery'] },
  Medical:    { icon: '💊', subcategories: ['Medicines','Vitamins & Supplements','First Aid','Ayurvedic','Baby Care','Personal Hygiene','Health Devices'] },
  Makeup:     { icon: '💄', subcategories: ['Lipstick & Lip Gloss','Foundation & BB Cream','Kajal & Eyeliner','Blush & Highlighter','Nail Polish','Skincare','Haircare'] },
